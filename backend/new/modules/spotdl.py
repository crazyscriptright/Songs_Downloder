...
class SpotDLDownloader:
    ...
    def download(self, spotify_url, output_dir='.', format='flac'):
        ...
        try:
            ...
            # SpotDL typically outputs: "Downloaded: filename.flac"
            ...
            # Fallback: look for newest file in output directory
            files = [
    ...
    def download_with_metadata(self, spotify_url, output_path, metadata=None):
        ...
        # Rename to match desired filename
...
if __name__ == '__main__':
    ...
    # Example: downloader.download('https://open.spotify.com/track/3n3Ppam7vgaVa1iaRUc9Lp', './test')
